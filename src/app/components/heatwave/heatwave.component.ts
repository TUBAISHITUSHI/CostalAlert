...
@Component({
  ...
  templateUrl: './heatwave.component.html',
  styleUrls: ['./heatwave.component.css']
})
export class HeatwaveComponent implements OnInit, AfterViewInit {
  ...
  intiMap():void {
    ...
    this.fetchAlertUpazila(2022, 21);
  }
  ...
  async genMapShapeFile(data_result:any) {
      ...
      this.mapLayer = L.geoJSON(data,{
        onEachFeature: function(feat,lyr){
          ...
          lyr.on({click: function(e) {
            ...
            that.fetchUpazilaData(u_code, 21);
          }})
    ...
    this.fetchUpazilaData(202224,21);
  }
