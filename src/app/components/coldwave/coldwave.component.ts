...
@Component({
  selector: 'app-coldwave',
  templateUrl: './coldwave.component.html',
  styleUrls: ['./coldwave.component.css']
})
export class ColdwaveComponent implements OnInit, AfterViewInit {
  ...
  intiMap():void {
    ...
    this.fetchAlertUpazila(2022, 22);
  }
  ...
  async genMapShapeFile(data_result:any) {
      ...
      this.mapLayer = L.geoJSON(data,{
        onEachFeature: function(feat,lyr){
          ...
          lyr.on({click: function(e) {
            ...
            that.fetchUpazilaData(u_code, 22);
          }})
    ...
    this.fetchUpazilaData(202224,22);
  }
